export const zhCN = {
  ...
  cards: {
    ...
    graphHubBadge: "图谱入口",
    graphHubDetail: "拓扑图、运行时图、冲击图、Dream 图以及其他已生成的 HTML 图谱，都可以从这里直接打开。",
    graphHubName: "图谱入口",
    graphHubTitle: "本轮已生成可查看的图谱",
    visualizerBadge: "TriadMind",
    visualizerDefaultDetail: "可以一键打开当前 TriadMind 为这一步生成的可视化结果。",
    visualizerDefaultTitle: "已生成可查看的图谱",
    visualizerDream: "查看 Dream 图",
    visualizerDreamDetail: "可以直接查看 Dream 结果图，判断提案、风险和演化方向是否合理。",
    visualizerDreamTitle: "Dream 图已生成",
    visualizerImpact: "查看冲击图",
    visualizerOpenHtml: "打开 HTML",
    visualizerReadyDetail: "只要已生成拓扑图、运行时图、冲击图或 Dream 图，这里都会给出直达入口。",
    visualizerReadyTitle: "相关图谱已就绪",
    visualizerRenormalize: "查看重整图",
    visualizerReviewDetail: "在继续实现前，可以先打开已经生成的拓扑图、冲击图或其他相关图做一次确认。",
    visualizerReviewTitle: "是否需要先查看图谱？",
    visualizerRuntime: "查看运行时图",
    visualizerRuntimeDetail: "可以直接打开运行时图，核对链路、边数和运行时拓扑结构。",
    visualizerRuntimeTitle: "运行时图已生成",
    visualizerSmallApprovedDetail: "当前冲击链较小，可以直接继续开发；需要的话也可以顺手查看相关图谱。",
    visualizerSmallApprovedTitle: "小需求已直接放行",
    visualizerTopology: "查看拓扑图",
  },
  planBadge: {
    blocked: "已阻塞",
    done: "完成",
  ...
  thread: {
    ...
    you: "你",
    graphActionsDetail: "在通过下一步之前，可以先打开冲击图、拓扑图、运行时图或 Dream 图做确认。",
    graphActionsTitle: "审批前先看图谱",
    graphActionsInlineHint: "如果需要，可以先打开下方已生成的图谱，再决定是否通过这一步。",
  },
  workdir: {
    browse: "浏览…",
    cancel: "取消",
