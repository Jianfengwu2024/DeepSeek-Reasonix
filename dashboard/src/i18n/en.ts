export const en = {
  ...
  cards: {
    ...
    graphHubBadge: "Graph Hub",
    graphHubDetail:
      "Topology, runtime, impact, Dream, and any other generated HTML graph can be opened directly from here.",
    graphHubName: "Graph Hub",
    graphHubTitle: "All generated graphs for this turn",
    visualizerBadge: "TriadMind",
    visualizerDefaultDetail:
      "Open the visualizations generated by TriadMind for this step with one click.",
    visualizerDefaultTitle: "Generated graphs are ready",
    visualizerDream: "View Dream Graph",
    visualizerDreamDetail:
      "Open the Dream result graph to review the proposal, risks, and evolution direction.",
    visualizerDreamTitle: "Dream graph is ready",
    visualizerImpact: "View Impact Graph",
    visualizerOpenHtml: "Open HTML",
    visualizerReadyDetail:
      "Any generated topology, runtime, impact, or Dream graph will show up here with a direct link.",
    visualizerReadyTitle: "Relevant graphs are ready",
    visualizerRenormalize: "View Renormalize Graph",
    visualizerReviewDetail:
      "Before continuing, open the generated topology, impact, or related graphs for a quick check.",
    visualizerReviewTitle: "Review graphs first?",
    visualizerRuntime: "View Runtime Graph",
    visualizerRuntimeDetail:
      "Open the runtime graph to verify the chain, edge count, and runtime topology.",
    visualizerRuntimeTitle: "Runtime graph is ready",
    visualizerSmallApprovedDetail:
      "The impact chain is small enough to continue directly. You can still open the related graphs if useful.",
    visualizerSmallApprovedTitle: "Small request passed directly",
    visualizerTopology: "View Topology Graph",
  },
  planBadge: {
    blocked: "Blocked",
    done: "Done",
  ...
  thread: {
    ...
    you: "You",
    graphActionsDetail:
      "Open the impact, topology, runtime, or Dream graph here before you approve the next step.",
    graphActionsTitle: "Review graphs before approval",
    graphActionsInlineHint: "You can open the generated graphs below before deciding whether to approve this step.",
  },
  workdir: {
    browse: "Browse…",
    cancel: "Cancel",
