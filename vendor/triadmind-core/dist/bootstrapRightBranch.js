...
exports.getBootstrapModuleRoles = getBootstrapModuleRoles;
exports.getSelfBootstrapNodeIds = getSelfBootstrapNodeIds;
exports.getSelfBootstrapLoopLines = getSelfBootstrapLoopLines;
exports.getSelfBootstrapMicroRules = getSelfBootstrapMicroRules;
exports.getSelfBootstrapPreamble = getSelfBootstrapPreamble;
/**
 * @RightBranch
 */
function getBootstrapModuleRoles() {
    return {
        Adapter: {
 ...
 * @RightBranch
 */
function getSelfBootstrapNodeIds() {
    return [
 ...
 * @RightBranch
 */
function getSelfBootstrapLoopLines() {
    return [
        'triadmind-core 源码',
 ...
 * @RightBranch
 */
function getSelfBootstrapMicroRules() {
    return [
 ...
 * @RightBranch
 */
function getSelfBootstrapPreamble() {
    return '这份文件是 TriadMind 对自己的顶点三元架构声明。它证明 TriadMind 不是只给别的项目立规矩，而是先用同一套规则描述自身。';
}
//# sourceMappingURL=bootstrapRightBranch.js.map