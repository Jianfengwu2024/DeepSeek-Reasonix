...
exports.getWorkflowPromptPolicyLines = getWorkflowPromptPolicyLines;
exports.getWorkflowSplitStageRequiredOutputRule = getWorkflowSplitStageRequiredOutputRule;
exports.buildTriadSpecDocumentTemplate = buildTriadSpecDocumentTemplate;
...
const WORKFLOW_SPLIT_STAGE_REQUIRED_OUTPUT_RULES = {
...
function getWorkflowPromptPolicyLines(key) {
    return [...WORKFLOW_PROMPT_POLICY_CATALOG[key]];
}
function getWorkflowSplitStageRequiredOutputRule(stage) {
    return WORKFLOW_SPLIT_STAGE_REQUIRED_OUTPUT_RULES[stage];
}
function buildTriadSpecDocumentTemplate(projectName) {
    return [
...
//# sourceMappingURL=workflowPromptCatalogSupport.js.map