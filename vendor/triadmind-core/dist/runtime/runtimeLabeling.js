...
exports.normalizeRuntimeNodeLabel = normalizeRuntimeNodeLabel;
exports.isLowSignalRuntimeLabel = isLowSignalRuntimeLabel;
...
function normalizeRuntimeNodeLabel(node) {
    const candidates = [];
...
function isLowSignalRuntimeLabel(label) {
    return scoreLabelCandidate(label).lowSignal;
}
function buildApiRouteLabel(node) {
...
function scoreLabelCandidate(label) {
...
//# sourceMappingURL=runtimeLabeling.js.map