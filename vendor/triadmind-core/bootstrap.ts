...
import { BootstrapPaths, normalizePath } from './workspace';
 ...
 * @LeftBranch
 */
export function buildSelfBootstrapArchitecture(paths: BootstrapPaths): SelfBootstrapArchitecture {
 ...
 * @LeftBranch
 */
export function writeSelfBootstrapReport(paths: BootstrapPaths) {
 ...
 * @LeftBranch
 */
export function buildSelfBootstrapProtocol(paths: BootstrapPaths): UpgradeProtocol {
 ...
 * @LeftBranch
 */
export function writeSelfBootstrapProtocol(paths: BootstrapPaths) {
    fs.mkdirSync(paths.triadDir, { recursive: true });
