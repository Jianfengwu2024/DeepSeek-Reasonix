...
function AppInner({
  ...
  const panelColumns = planPanelOpen
    ? splitPlanPanelColumns(terminalColumns)
    : { mainColumns: terminalColumns, panelColumns: 0 };
    ...
    <>
      <TickerProvider disabled={tickerSuspended}>
        <InflightProvider inflight={loop.inflight}>
          <Box flexDirection="row" backgroundColor={SURFACE.bg}>
            <Box
              ...
              width={planPanelOpen ? panelColumns.mainColumns : undefined}
            >
              <TerminalColumnsProvider columns={panelColumns.mainColumns}>
        ...
        */}
            ...
            {planPanelOpen ? (
              <TerminalColumnsProvider columns={panelColumns.panelColumns}>
                <PlanPanel
